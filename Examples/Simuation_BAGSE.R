...
t$enrichment_est
#Should be -3.07 for a0 and 0.93 for a1. 

#If you want to compare the results to the R package, the R code is in the R folder in the repo, function name is torus
